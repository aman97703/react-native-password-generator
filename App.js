...
const PasswordSchema = yup.object().shape({
  passwordLength: yup
    ...
    .max(16, 'Should be max of16 characters')
...
export default function App() {
  ...
  const generatedPasswordString = passwordLen => {
    let characterList = '';
  ...
  const createPassword = (character, passwordLen) => {
    let result = '';
  ...
  return (
    <View style={{backgroundColor:"#2a282c", height:"100%"}}>
